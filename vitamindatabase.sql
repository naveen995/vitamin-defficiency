...
insert  into `recomend`(`predicted`,`recomend`) values (1,'Fruits and Dryfruits'),(2,'Fruits and cereals and  vegetables and  millets and Dryfruits'),(3,'cheese and curd and milk and meat and Dryfruits'),(4,'Fruits and cereals and vegetables and millets and Dryfruits and cheese and curd and milk and meat'),(5,'cereals and vegetables and millets and Dryfruits and cheese and curd and milk and meat'),(6,'cereals and vegetables and millets and Dryfruits');
...
CREATE TABLE `upload` (
  ...
  `vitek` varchar(100) DEFAULT NULL,
